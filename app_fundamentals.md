...
Now that we've reviewed the basics of Android applications, it's time to start reversing them! This section will be split into a couple of different parts:

* Where do we [begin our static analysis](#starting-points-for-re) when we want to RE an Android applications
* Reversing the DEX code of Android apps
* Reversing native libraries (C/C++ compiled code) included in Android apps
